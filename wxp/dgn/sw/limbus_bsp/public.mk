...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../syn/syn_zen_fpga_top.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2011068
SOPC_SYSID_FLAG += --sidp=0x2011068
ELF_PATCH_FLAG  += --sidp 0x2011068

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1384067151
SOPC_SYSID_FLAG += --timestamp=1384067151
ELF_PATCH_FLAG  += --timestamp 1384067151
